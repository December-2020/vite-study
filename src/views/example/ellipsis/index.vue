  ...
  <div class="wrapper">
    ...
    <div class="wrapper-content mt-4 b-rd-4px overflow-hidden">
      <el-collapse v-model="activeCollapse">
        ...
        <!-- <el-collapse-item title="单行中间隐藏(英文)" name="4">
          <div class="collapse-item-content center-ellipsis">
            <span class="txt">{{ testEnglishText }}</span>
            <span class="title" :title="testEnglishText">
              {{ testEnglishText }}
            </span>
          </div>
        </el-collapse-item> -->
...
const defaultText = `永和九年，岁在癸丑，暮春之初，会于会稽山阴之兰亭，修禊事也。群贤毕至，少长咸集。
            ...
            `;
// const testEnglishText = `Lorem ipsum dolor sit amet consectetur adipisicing elit. Ab nemo suscipit consequatur nulla. Sed alias, voluptatum ducimus nihil deserunt voluptate veritatis sequi esse saepe, temporibus quo inventore labore quaerat dolore.`;
